...
const gridState3: DataGridState = {
  columnsConfig: [
    {
      locked: true,
      columnWidth: 45,
...
for (const [index, rowItem] of Object.entries(gridState3.data)) {
  rowItem.rowUniqueId = 'rowNumber' + index;
  rowItem.status = statusDropdownData.find((d) => d.text === rowItem.status).text;
}
export const MOCK_GRID_STATE_3 = gridState3;
